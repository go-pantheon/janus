...
```
W0414 11:47:02.772394   46191 library.go:276] module github.com/go-pantheon/janus has empty version, defaults to HEAD. The license URL may be incorrect. Please verify!
```
