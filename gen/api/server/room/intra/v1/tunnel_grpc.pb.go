...
const (
	TunnelService_Tunnel_FullMethodName = "/server.room.intra.v1.TunnelService/Tunnel"
)
...
var TunnelService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "server.room.intra.v1.TunnelService",
	...
	Metadata: "room/intra/v1/tunnel.proto",
}
