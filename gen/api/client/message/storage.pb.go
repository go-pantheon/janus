...
type SCUsePack struct {
	...
	ChangedItems  map[int64]uint64       `protobuf:"bytes,3,rep,name=changed_items,json=changedItems,proto3" json:"changed_items,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // Items with changed amounts. item DataID -> current amount. value is 0 means the item has been deleted
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type UserStorageProto struct {
	state            protoimpl.MessageState          `protogen:"open.v1"`
	Amounts          map[int64]uint64                `protobuf:"bytes,1,rep,name=amounts,proto3" json:"amounts,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`                                          // Numeric items. item DataID -> amount
...
var file_message_storage_proto_rawDesc = string([]byte{
	...
	0x6f, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x61, 0x78, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x6d, 0x61, 0x78, 0x12, 0x2c, 0x0a, 0x12, 0x72, 0x65, 0x63,
