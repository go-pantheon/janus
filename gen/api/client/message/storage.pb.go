...
type SCPushItemUpdated struct {
	...
	Items         map[int64]int64        `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // Items with changed amounts. item DataID -> current amount. value is 0 means the item has been deleted
...
func (x *SCPushItemUpdated) GetItems() map[int64]int64 {
	if x != nil {
		return x.Items
	}
	return nil
...
type SCUsePack struct {
	...
	ChangedItems  map[int64]int64        `protobuf:"bytes,3,rep,name=changed_items,json=changedItems,proto3" json:"changed_items,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` // Items with changed amounts. item DataID -> current amount. value is 0 means the item has been deleted
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SCUsePack) GetChangedItems() map[int64]int64 {
	if x != nil {
...
type UserStorageProto struct {
	state            protoimpl.MessageState          `protogen:"open.v1"`
	Amounts          map[int64]int64                 `protobuf:"bytes,1,rep,name=amounts,proto3" json:"amounts,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`                                          // Numeric items. item DataID -> amount
	Packs            map[int64]*ItemPackProto        `protobuf:"bytes,2,rep,name=packs,proto3" json:"packs,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`                                               // Packs. pack DataID -> amount
	RecoverableItems map[int64]*ItemRecoverableProto `protobuf:"bytes,3,rep,name=recoverable_items,json=recoverableItems,proto3" json:"recoverable_items,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Recoverable items. item DataID -> properties
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *UserStorageProto) GetAmounts() map[int64]int64 {
	if x != nil {
		return x.Amounts
	}
	return nil
...
type ItemRecoverableProto struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	Count            int64                  `protobuf:"varint,1,opt,name=count,proto3" json:"count,omitempty"`                                                  // Current amount
	Max              int64                  `protobuf:"varint,2,opt,name=max,proto3" json:"max,omitempty"`                                                      // Maximum
...
func (x *ItemRecoverableProto) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *ItemRecoverableProto) GetMax() int64 {
	if x != nil {
		return x.Max
	}
	return 0
...
var file_message_storage_proto_rawDesc = string([]byte{
	...
	0x01, 0x0a, 0x11, 0x53, 0x43, 0x50, 0x75, 0x73, 0x68, 0x49, 0x74, 0x65, 0x6d, 0x55, 0x70, 0x64,
	0x61, 0x74, 0x65, 0x64, 0x12, 0x3b, 0x0a, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x01, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x53, 0x43,
	0x50, 0x75, 0x73, 0x68, 0x49, 0x74, 0x65, 0x6d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x2e,
	...
	,
	...
	,
	...
	0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x05, 0x70, 0x61, 0x63, 0x6b, 0x73, 0x12, 0x5c, 0x0a,
	0x11, 0x72, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x69, 0x74, 0x65,
	0x6d, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x50, 0x72,
	0x6f, 0x74, 0x6f, 0x2e, 0x52, 0x65, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x61, 0x62, 0x6c, 0x65, 0x49,
	0x74, 0x65, 0x6d, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x10, 0x72, 0x65, 0x63, 0x6f, 0x76,
	0x65, 0x72, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x1a, 0x3a, 0x0a, 0x0c, 0x41,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x50, 0x0a, 0x0a, 0x50, 0x61, 0x63, 0x6b, 0x73,
	...
	,
	...
	,
...
var file_message_storage_proto_goTypes = []any{
	...
	nil,                          // 7: message.SCPushItemUpdated.ItemsEntry
...
var file_message_storage_proto_depIdxs = []int32{
	7,  // 0: message.SCPushItemUpdated.items:type_name -> message.SCPushItemUpdated.ItemsEntry
